...
python -m nuitka --include-data-file=res/default.css=res/default.css --include-data-file=res/functions.js=res/functions.js --include-data-file=res/logo_base64.txt=res/logo_base64.txt --include-data-file=res/logo.png=res/logo.png --onefile il_conv.py
